...
const AdminUserCreation: React.FC<AdminUserCreationProps> = ({ onUserCreated, onClose }) => {
  ...
  const onSubmit = async (data: AdminCreateUserData) => {
    try {
      ...
      console.log('- First name:', trimmedData.firstName, 'Length:', trimmedData.firstName.length);
      console.log('- Last name:', trimmedData.lastName, 'Length:', trimmedData.lastName.length);
      console.log('- Username:', trimmedData.username, 'Length:', trimmedData.username.length);
      console.log('- Email:', trimmedData.email, 'Length:', trimmedData.email.length);
      console.log('- Password:', trimmedData.password, 'Length:', trimmedData.password.length);
      console.log('- Role:', trimmedData.role);
      console.log('- Phone:', trimmedData.phone, 'Length:', trimmedData.phone.length);
      ...
      setError(`User creation failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
  };
